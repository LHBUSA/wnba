...
export function todayView({ today, arts, injuries, standings, intl = null }) {
  ...
  return { live: live || intlLive, body: html`
    ...
    ${priced.length ? html`<section class="section">
      <div class="sec-head"><h2 class="sec-title bc">Market board</h2><span class="note">PropSports.PropTechUSA.ai Market Feed · best price across books · captured ${fmtDateTimeET(d.market.captured_at)} · never refreshed by page views</span></div>
