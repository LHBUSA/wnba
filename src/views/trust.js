...
export const SOURCE_REGISTRY = [
  ...
  ['Wikimedia Commons', 'Player photographs used under their stated Creative Commons or public-domain licenses, with author, license and source attribution on the full article or player page, matched to the player by Wikidata identity and reviewed before use.'],
