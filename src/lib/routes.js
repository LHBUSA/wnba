...
export const ROUTE_TABLE = [
  ...
  { id: 'player-dna', re: /^\/players\/(\d{3,12})\/dna$/, keys: ['playerId'] },
  ...
  { id: 'pbe-picks', re: /^\/pbe-picks$/ },
  { id: 'pbe-model', re: /^\/pbe-picks\/model$/ },
  { id: 'player-load', re: /^\/player-load$/ },
  { id: 'daily-brief', re: /^\/brief$/ },
  { id: 'edge-timeline', re: /^\/edge-timeline$/ },
  { id: 'rotation-impact', re: /^\/rotation-impact$/ },
  { id: 'scenario-lab', re: /^\/scenario-lab$/ },
